              ...
              >
                {bubble?.petId === p.id && (
                  <div className="absolute bottom-full left-1/2 mb-1.5 -translate-x-1/2">
                    <div
                      className="relative w-max rounded-md border border-white/25 px-2 py-1 text-center text-[11px] leading-snug text-white"
                      style={{ background: CHIP_BG, textShadow: TEXT_OUTLINE, maxWidth: "min(70vw, 200px)", overflowWrap: "anywhere" }}
                    >
                      {bubble.text}
                      {/* 꼬리(tail) — 칩과 같은 어두운 색 */}
                      <span
